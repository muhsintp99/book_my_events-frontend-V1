...
import {
    ...
    IconButton, Box, TextField, InputAdornment, Button,
    Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle,
    Typography, Snackbar, Alert, CircularProgress, Chip, Stack
} from '@mui/material';
import {
    Edit, Delete, Add as AddIcon,
    Search as SearchIcon
} from '@mui/icons-material';
import { useNavigate } from 'react-router-dom';
import { API_BASE_URL, getApiImageUrl } from '../utils/apiImageUtils';

const EventProfessionalList = () => {
    ...
    return (
        <Box p={3}>
            <Stack direction="row" justifyContent="space-between" alignItems="center" mb={3}>
                <Typography variant="h4" fontWeight="bold">Event Professional List</Typography>
                <Button variant="contained" color="primary" startIcon={<AddIcon />} onClick={() => navigate('/eventprofessionals/AddProvider')}>
                    Add Professional
                </Button>
            </Stack>
                ...
                <Table>
                    ...
                    <TableBody>
                        {loading ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={7} align="center" py={5}>No professionals found</TableCell>
                            </TableRow>
                        ) : (
                            filtered.map((item, idx) => (
                                <TableRow key={item._id} hover>
                                    ...
                                    <TableCell align="right">
                                        <IconButton size="small" color="primary" onClick={() => navigate(`/eventprofessionals/AddProvider/${item._id}`)}><Edit /></IconButton>
            ...
            <Dialog open={openDeleteDialog} onClose={() => setOpenDeleteDialog(false)}>
                ...
                <DialogContent><DialogContentText>Are you sure you want to delete this professional provider?</DialogContentText></DialogContent>
                <DialogActions>
...
export default EventProfessionalList;
