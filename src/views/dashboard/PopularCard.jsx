...
const allModules = [
  ...
  { name: 'Florists & Stage', bookings: 285, trend: 'up', note: '+5.2% growth' },
  { name: 'Cakes', bookings: 210, trend: 'up', note: '+9.8% demand' },
  { name: 'Invitation & Printing', bookings: 195, trend: 'down', note: '-2.4% trend' },
  { name: 'Light & Sounds', bookings: 178, trend: 'up', note: '+14.2% growth' },
  { name: 'Boutique', bookings: 145, trend: 'up', note: '+6.5% peak' },
  { name: 'Bouncers & Security', bookings: 112, trend: 'up', note: '+20.1% new demand' },
  { name: 'Emcee', bookings: 98, trend: 'up', note: '+4.3% growth' },
  { name: 'Panthal & Decorations', bookings: 85, trend: 'up', note: '+11.2% growth' },
