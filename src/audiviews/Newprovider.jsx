...
function AuditoriumProviderList() {
  ...
  return (
    <Box p={3} bgcolor="#f4f6f8" minHeight="100vh">
      {/* Header */}
      <Paper sx={{ p: 3, mb: 3, borderRadius: 2, background: 'linear-gradient(135deg, #FF6B6B 0%, #556270 100%)' }}>
        <Typography variant="h5" fontWeight={600} color="white">
          Auditorium Providers
        </Typography>
        <Typography variant="body2" color="rgba(255,255,255,0.9)">
          Manage auditorium vendors and view detailed profiles
        </Typography>
      </Paper>
                    ...
                    >
                      ...
                      <TableCell>
                        <Chip
                          label={vendor.module}
                          size="small"
                          sx={{ bgcolor: 'rgba(255, 107, 107, 0.1)', color: '#FF6B6B', fontWeight: 500 }}
                        />
                      </TableCell>
                        ...
                        <Stack direction="row" spacing={0.5} justifyContent="center">
                          ...
                          <Tooltip title="Edit">
                            <IconButton
                              size="small"
                              color="primary"
                              onClick={() => navigate(`/auditorium/addprovider/${vendor.vendorId}`)}
                            >
                              <EditIcon />
                            </IconButton>
                          </Tooltip>
...
export default AuditoriumProviderList;
