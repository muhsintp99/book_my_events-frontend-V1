...
function OrnamentsProviderList() {
    ...
    <Box p={3} bgcolor="#f4f6f8" minHeight="100vh">
      ...
      <Paper sx={{ p: 3, mb: 3, borderRadius: 2, background: 'linear-gradient(135deg, #a1c4fd 0%, #c2e9fb 100%)' }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Manage ornaments vendors and view detailed profiles
        </Typography>
      </Paper>
                        ...
                        <Stack direction="row" spacing={0.5} justifyContent="center">
                          <Tooltip title="View Details">
                            <IconButton
                              ...
                              sx={{
                                color: '#a1c4fd',
                                '&:hover': { bgcolor: 'rgba(161, 196, 253, 0.1)' }
                              }}
                          ...
                          <Tooltip title="Edit">
                            <IconButton
                              size="small"
                              color="primary"
                              onClick={() => navigate(`/catering/addprovider/${vendor.vendorId}`)}
                            >
                              <EditIcon />
                            </IconButton>
                          </Tooltip>
...
export default OrnamentsProviderList;
