...
export default function PopularCard({ isLoading = false, data, title }) {
          ...
          <CardContent sx={{ p: '24px !important' }}>
            <Grid container spacing={gridSpacing}>
              ...
              <Grid item xs={12}>
                <Grid container alignItems="center" justifyContent="space-between">
                  <Grid item>
                    <Typography variant="h4" sx={{ fontWeight: 800 }}>{title || 'Top Booked Modules'}</Typography>
                  </Grid>
                  <Grid item>
                  ...
                  <Box sx={{ p: 2, pb: 0, position: 'relative', zIndex: 1 }}>
                    <Stack direction="row" alignItems="center" justifyContent="space-between">
                      <Typography variant="subtitle2" sx={{ fontWeight: 700, color: 'rgba(255,255,255,0.8)' }}>
                        {title?.includes('Invitation') ? 'Total Invitation Revenue' : 'Live Providers'}
                      </Typography>
                      <Typography variant="h3" sx={{ fontWeight: 800, color: '#fff' }}>
                        {title?.includes('Invitation') ? '₹51,000' : '2.5k+'}
                      </Typography>
                    </Stack>
                  </Box>
