    ...
    <Box sx={{ p: 3 }}>
                ...
                <Table>
                  ...
                  <TableBody>
                    {portfolioList.length === 0 ? (
                      <TableRow><TableCell colSpan={6} align="center">No images yet</TableCell></TableRow>
                    ) : (
        ...
        {tabValue === 1 && (
          <>
            <CardContent>
              ...
              <Box sx={{ mb: 3 }}>
                {videoTags.map((t, i) => (
                  <Chip key={i} label={t} onDelete={() => setVideoTags(p => p.filter((_, x) => x !== i))} sx={{ mr: 1 }} />
                ))}
              </Box>
              <TextField
                fullWidth
            ...
            <CardContent>
              ...
              <TableContainer component={Paper}>
                <Table>
                  ...
                  <TableBody>
                    {videoList.length === 0 ? (
                      <TableRow><TableCell colSpan={6} align="center">No videos yet</TableCell></TableRow>
                    ) : (
      ...
      <Dialog open={mediaModalOpen} onClose={closeFullscreen} maxWidth="lg" fullWidth>
        <DialogContent sx={{ bgcolor: 'black', position: 'relative', minHeight: '80vh', p: 0 }}>
          <IconButton onClick={closeFullscreen} sx={{ position: 'absolute', top: 10, right: 10, zIndex: 10, color: 'white' }}>
            <Close />
          </IconButton>
