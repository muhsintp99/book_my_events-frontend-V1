...
const BouncerList = () => {
    ...
    const API_URL = `${API_BASE_URL}/bouncers`;
    ...
    return (
        <Box p={3}>
            <Stack direction="row" justifyContent="space-between" alignItems="center" mb={3}>
                <Typography variant="h4" fontWeight="bold">Bouncers & Security List</Typography>
                <Button variant="contained" color="primary" startIcon={<AddIcon />} onClick={() => navigate('/bouncers/AddProvider')}>
                    Add Bouncer / Security
                </Button>
            </Stack>
                            ...
                            filtered.map((item, idx) => (
                                <TableRow key={item._id} hover>
                                    ...
                                    <TableCell align="right">
                                        <IconButton size="small" color="primary" onClick={() => navigate(`/bouncers/AddProvider/${item._id}`)}><Edit /></IconButton>
