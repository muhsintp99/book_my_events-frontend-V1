...
function MakeupProviderList() {
  ...
  return (
    <Box p={3} bgcolor="#f4f6f8" minHeight="100vh">
      {/* Header */}
      <Paper sx={{ p: 3, mb: 3, borderRadius: 2, background: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)' }}>
        <Typography variant="h5" fontWeight={600} color="white">
          Makeup Providers
        </Typography>
        <Typography variant="body2" color="rgba(255,255,255,0.9)">
          Manage makeup vendors and view detailed profiles
        </Typography>
      </Paper>
                        ...
                        <Stack direction="row" spacing={0.5} justifyContent="center">
                          ...
                          <Tooltip title="Edit">
                            <IconButton
                              size="small"
                              color="primary"
                              onClick={() => navigate(`/makeup/AddProvider/${vendor.vendorId}`)}
                            >
                              <EditIcon />
                            </IconButton>
                          </Tooltip>
...
export default MakeupProviderList;
