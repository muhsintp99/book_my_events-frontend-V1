...
function MakeupProvider() {
  ...
  const isMultiZoneModule = () => true; // Makeup always supports multi-zone
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        // setTimeout(() => {
        //   navigate('/providers/makeupprovider');
        // }, 2000);
        return;
      }
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#f9f9f9', borderRadius: 2 }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        {/* Multi-Zone (only for Makeup, Photography, Catering) */}
